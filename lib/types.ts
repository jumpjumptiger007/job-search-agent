...
export interface DiscoveredJob { company:string; title:string; location?:string; url:string; sourceName:string; ats?:string; externalId?:string; description:string; contentStatus?:ContentStatus; postedAt?:string; workModel?:string; discoveredVia?:string; }
...
export interface DiscoveryPreferences { roleFamilies?:string[]; location?:string; radiusKm?:number; remotePreference?:string; seniority?:string[]; workingLanguage?:WorkingLanguage; otherLanguages?:OtherLanguagePreference[]; postingAgeDays?:number; limits?:{perRun?:number}; }
