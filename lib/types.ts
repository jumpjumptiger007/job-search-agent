...
export interface DiscoveryPreferences { roleFamilies?:string[]; location?:string; radiusKm?:number; remotePreference?:string; seniority?:string[]; language?:string[]; postingAgeDays?:number; limits?:{perRun?:number}; }
